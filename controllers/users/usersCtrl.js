...
const generateVerificationTokenCtrl = expressAsyncHandler(async (req, res) => {
  ...
  try {
    ...
    const resetURL = `If you were requested to verify your account, verify now within 10 minutes, otherwise ignore this message <a href="https://blog-backend-jol4.onrender.com/verify-account/${verificationToken}">Click to Verify</a>`;
    const mailOptions = {
...
const forgetPasswordTokenCtrl = expressAsyncHandler(async (req, res) => {
  ...
  try {
    ...
    //build your message
    const resetURL = `If you were requested to reset your password, reset now within 10 minutes, otherwise ignore this message <a href="https://blog-backend-jol4.onrender.com/reset-password/${token}">Click to Reset</a>`;
    const mailOptions = {
      from: process.env.ADMIN_EMAIL,
      to: email,
